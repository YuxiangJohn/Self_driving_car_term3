...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer7_up = tf.layers.conv2d_transpose(layer7_conv_1x1, num_classes, 4,
                                             strides= (2, 2),
                                             padding= 'same',
                                             kernel_initializer= tf.random_normal_initializer(stddev=0.01),
                                             kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    layer4_skip = tf.add(layer7_up,  layer4_conv_1x1)

    layer4_up = tf.layers.conv2d_transpose(layer4_skip, num_classes, 4,
                                             strides= (2, 2),
                                             padding= 'same',
                                             kernel_initializer= tf.random_normal_initializer(stddev=0.01),
                                             kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    layer3_skip = tf.add(layer4_up, layer3_conv_1x1)
